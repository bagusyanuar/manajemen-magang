...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-1">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.staff') }}">Karyawan</a></li>
    ...
    <div class="card-content">
        <form method="post" id="form-data">
            ...
            <div class="w-100 mb-3">
                <label for="name" class="form-label input-label">Nama Karyawan <span
                        class="color-danger">*</span></label>
                <input type="text" placeholder="nama karyawan" class="text-input" id="name"
            ...
            <div class="w-100 mb-3">
                ...
                <select id="role" name="role" class="text-input">
                    ...
                    <option value="karyawan" {{ $data->user->role == 'karyawan' ? 'selected' : '' }}>Karyawan</option>
                </select>
                @if($errors->has('role'))
                    <span id="role-error" class="input-label-error">
                        {{ $errors->first('role') }}
                    </span>
                @endif
            </div>
